        ...
        slivers: [
          SliverList(
            delegate: SliverChildListDelegate([
              ...
              SizedBox(height: 30),
              Container(
                padding: EdgeInsets.symmetric(horizontal: 25.0),  // Ajusta el padding según tus necesidades
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Descubre la mejor comodidad para tù pròximo viaje',
                      textAlign: TextAlign.center,
              ...
              SizedBox(height: 20), // Espacio entre la descripción y el contenido
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              color: Color(0xE7E7E7E7), // Aquí estableces el color de fondo usando un valor hexadecimal
